    ...
    <div id="admin">
        ...
        <b-row class="content">
            <b-col class="col-lg-4">
                <b-card>
                    <b-card-text>
                        <b-button @click="usersProp()" class="btns">Utilizadores</b-button><br>
                        <b-button @click="companiesProp()" class="btns">Empresas</b-button><br>
                        <b-button @click="offersProp()" class="btns">Ofertas</b-button><br>
                        <b-button @click="eventsProp()" class="btns">Eventos</b-button><br>
                    </b-card-text>
                </b-card>
            </b-col>
                ...
                <b-card>
                    <b-card-text>
                        ...
                        <div v-if="this.companyContent.length != 0">
                            <CompaniesTable :companyContent="companyContent"></CompaniesTable>
                        </div>
    ...
    export default {
        ...
        methods: {
            usersProp() {
                ...
                this.eventsContent = []
                this.offersContent = []
                this.userContent = this.$store.state.users.filter(user => user.type != 'admin');
            },
            companiesProp() {
                this.userContent = []
                this.eventsContent = []
